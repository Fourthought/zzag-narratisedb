"""Scrape a MAIB report page on GOV.UK to extract metadata and download the PDF."""
import re
...
def scrape(url: str) -> ScrapedReport:
    ...
    Raises ValueError if no PDF attachment is found on the page.
...
def _extract_metadata(soup: BeautifulSoup) -> dict:
    ...
    for dt in soup.select("dt.gem-c-metadata__term"):
